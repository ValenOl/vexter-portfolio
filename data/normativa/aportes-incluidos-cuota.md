...
1. **Impuesto integrado**: reemplaza el IVA y Ganancias que pagaría un
   Responsable Inscripto por la misma actividad.
2. **Aporte jubilatorio (SIPA)**: cuenta como aporte a la jubilación,
   igual que el descuento de un empleado en relación de dependencia.
3. **Aporte a obra social**: da cobertura de salud, con la obra social
